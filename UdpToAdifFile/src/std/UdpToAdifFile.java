...
public class UdpToAdifFile {
    ...
    public static void main(String[] args) {
       ...
       // Create a label for configuration
        ...
        JLabel lblUselessUdp = new JLabel("0 Ignored UDP packet");
        lblUselessUdp.setBounds(491, 41, 350, 23);
        frame.getContentPane().add(lblUselessUdp);
        ...
        try (DatagramSocket receiveSocket = new DatagramSocket(null)) {
            ...
            while (true) {
                ...
                if (!start.contains("<STATION_CALLSIGN")) {
                    ...
                    lblUselessUdp.setText(uselessUdp + " Ignored UDP packet");
                    // go to the last line
