...
This app it's designed for hamradio operators to integrate logging data from applications like MSHV, JTDX, WSJT, Decodium etc. integrate them with other data and send to a logger like Log4OM2.
The way it wirks is:
