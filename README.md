...
In the directories you can find the source code and the compiled program you can install on your Windows PC. Pre-requiite is to have Java Virtual Machine installed.
